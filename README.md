...
Once you write this mapping layer between Selenium and the application context, then writing tests is not only easier, but it better reflects the application. Such a test could run lines like:
